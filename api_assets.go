...
func (r ApiApiV3AssetsGetRequest) Filter(filter string) ApiApiV3AssetsGetRequest {
	r.filter = &filter
	return r
}
...
*/
func (a *AssetsApiService) ApiV3AssetsGet(ctx context.Context) ApiApiV3AssetsGetRequest {
	return ApiApiV3AssetsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
